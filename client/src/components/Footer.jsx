  ...
  <div className="container mx-auto px-6 md:flex md:justify-between md:items-center text-sm">
    ...
    <div className="md:w-1/2 text-center md:text-right">
      ...
      <div className="flex justify-center md:justify-end space-x-3 mt-4">
        <a href="https://www.facebook.com/profile.php?id=61565371378900&mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-500 transition duration-200 ease-in-out">
          <FaFacebookF size={24} />
        </a>
